...
const Tabs = ({activeTabName, onClickTab}) => {
    ...
    const renderTabTitle = (tabTitle, isActive, icon, id)=> (
        <div
         ...
         onClick={()=> onClickTab(tabTitle)} id={id} className={`tab-item ${isActive && "tab-border"}`}>
            <i className={icon}></i>
            <p>{tabTitle}</p>
                   ...
                   <div className="container">
                       ...
                       >
                            <div className="tab-1-content-inner">
                                <div>
                                    <p className="text-lg">
                                        If you decided Netflix isn't for you - no problem.
                                         No commitment. Cancel online anytime
                                    </p>
                                    <Link to="./netflix-show" className="btn btn-1g">
                   ...
                   <div id ="tab-2-content" className={`tab-content-item 
                    ...
                    >
                        <div className="tab-2-content-top">
                            <p className="text-lg">
                                Watch TV shows and movies anytime, anywhere - personalize for your.
                    ...
                    <div id ="tab-3-content" className={`tab-content-item 
                        ...
                        >
                            ...
                            <table className="table">
                                ...
                                <tbody>
                                    <tr>
                                        <td>Monthly price after free month ands on 6/19/2021</td>
                                        <td>$6.99</td>
                                        <td>$11.99</td>
                                        <td>$15.99</td>
                                    </tr>
